          ...
          return (
            <button
              ...
              style={{
                ...
                fontSize: 13,
                fontWeight: 500,
                color: active ? "var(--rre-accent)" : completed ? "var(--s-text)" : "var(--s-text-tertiary)",
                background: active ? "var(--rre-accent-50)" : "transparent",
                border: "none",
            ...
            >
              <span
                style={{
                  ...
                  height: 22,
                  borderRadius: "50%",
                  background: active ? "var(--rre-accent)" : completed ? "var(--s-success)" : "var(--s-surface-alt)",
