-- Revenue KPIs (total_sales / orders / aov / avg_items_per_order) now read the
-- sales_order ENTITY (keyed on order_id → dedup-proof) instead of summing
-- Completed-order events. Everything else unchanged from _013.
